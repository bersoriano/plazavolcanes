    ...
    >
      <div className="relative overflow-hidden rounded-[2rem] bg-brand px-6 py-10 text-white sm:px-10 sm:py-14 lg:px-14">
        ...
        <div className="relative">
          ...
          <h1
            className="mt-3 max-w-2xl font-display text-4xl font-semibold leading-[1.05] tracking-[-0.04em] sm:text-6xl"
            id="vender-heading"
          >
          ...
          <div className="mt-12 rounded-[1.5rem] border border-white/15 bg-white/5 p-6 sm:p-8">
            ...
            <dl className="mt-6 grid gap-4 sm:grid-cols-3">
              {tiers.map((tier) => {
                ...
                return (
                  <div className="rounded-[1.25rem] bg-brand-hover/60 p-5" key={tier}>
                    ...
                    <p className="mt-2 text-sm leading-6 text-white/80">{marker.tooltip}</p>
                  </div>
                );
              })}
            </dl>
